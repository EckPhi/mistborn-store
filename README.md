...
| | Name | Description |
|---|---|---|
| <img src="apps/agentgateway/metadata/logo.jpg" width="32"> | [agentgateway](https://github.com/agentgateway/agentgateway) | MCP gateway that aggregates many MCP servers behind one endpoint |
| <img src="apps/akaunting/metadata/logo.jpg" width="32"> | [Akaunting](https://github.com/akaunting/docker) | Free and open-source accounting software for small businesses |
